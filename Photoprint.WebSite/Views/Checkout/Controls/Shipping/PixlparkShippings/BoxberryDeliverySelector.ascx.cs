...
{
    public partial class BoxberryDeliverySelector : BaseShippingSelectorControl
    {
        ...
        public override OrderAddress GetSelectedOrderAddress()
        {
            ...
            var parsedShippingAddress = GetSelectedShippingAddressByParse();
            ...
            OrderAddress.MiddleName = !(chkAllowRegisterWithoutMiddleName?.Checked ?? true) ? txtMiddleName.Text.Trim() : string.Empty;
        ...
        private ShippingAddress GetSelectedShippingAddressByParse()
        {
            ...
            switch (item)
            {
                ...
                case AddressItem.AddressLine1:
                    if (plhdAddresses.Visible && !string.IsNullOrWhiteSpace(Request.Form[ddlAddresses.UniqueID]))
                    {
                        ...
                        if (shippingAddresses.Any(a => a.Id == addressesId) && shippingAddresses.FirstOrDefault(a => a.Id == addressesId) != null)
        ...
        protected BoxberryDeliverySelector()
        {
            Load += Page_Load;
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            txtPostalCode.AutoPostBack = true;
        ...
        public override bool ValidateInput()
        {
            ...
            var isValid = ValidateSelectableInput() && reqFirstName.IsValid && reqLastName.IsValid && reqMiddleName.IsValid && reqPhone.IsValid &&
                          ...
                          (!plhdClientShipping.Visible || reqAddressHouse.IsValid && reqAddressFlat.IsValid) &&
       ...
       // protected bool CstCityReqFunc => ddlStreets.SelectedValue != "0";
        ...
        protected void CstPostalCodeCorrect(object source, ServerValidateEventArgs args)
        {
            args.IsValid = ValidateAddress().IsIndexValid.GetValueOrDefault(false);
        }
