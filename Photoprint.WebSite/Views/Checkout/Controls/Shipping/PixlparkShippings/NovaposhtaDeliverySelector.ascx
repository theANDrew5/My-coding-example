<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NovaposhtaDeliverySelector.ascx.cs" Inherits="Photoprint.WebSite.Controls.NovaposhtaDeliverySelector" %>
        ...
        <fieldset class="profile postal" id="postal_<%: InitializedPostal?.Id ?? 0 %>">
	        <ol>
	            ...
	            <li class="shipping-phone">
                    ...
                    <span class="hint"><%=RM.GetString(RS.Shop.Checkout.Novaposhta.PhoneWarning) %></span>
	            </li>
                ...
                <asp:PlaceHolder runat="server" ID="plhdClientShipping" Visible="False">
                    ...
                    <asp:PlaceHolder ID="plhdStreetSelector" runat="server" Visible="False">
                        <li>
                            <label for="<%=ddlStreets.ClientID %>"><%= RM.GetString(RS.Shop.Checkout.AddressStreet) %></label>
                            <asp:DropDownList ID="ddlStreets" ValidationGroup="Shipping" runat="server"/>
                    ...
                    <asp:PlaceHolder ID="plhdStreetInput" runat="server" Visible="False">
                        <li>
