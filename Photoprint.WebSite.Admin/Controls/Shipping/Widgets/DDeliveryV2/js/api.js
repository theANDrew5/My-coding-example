!function () {
    ...
    window.DDeliveryWidgetCart = function (t, a, r, n) {
        if (!t)
            return console.error("DDeliveryWidgetCart: Argument 'id' is required.");
        if ("object" != typeof a)
            return console.error("DDeliveryWidgetCart: Argument 'params' is required and must be an object.");
        if (void 0 === n ? n = "https://ddelivery.ru" : "" !== n && "/" !== n || (n = location.protocol + "//" + location.hostname),
            a.lang && window.messages[a.lang] || (a.lang = "ru"),
            a.apiScript || (a.apiScript = "/dd-widget-api.php"),
                ...
                I.length ? o("error", I) : (p = n,
                    ...
                    v = function (i) {
                        if ("ok" === i.status) {
                            ...
                            e(t, function (e) {
                                var o = a.apiScript + (-1 === a.apiScript.search(/\?/) ? "?" : "&") + "url=" + n + "/front/widget-cart/public/widget/main.php";
                    ...
                    f.onreadystatechange = function () {
                        ...
                        4 === f.readyState && (200 === f.status ? v(JSON.parse(response)) : console.error("Ошибка при обращении к API-скрипту или серверу SafeRoute"))
                    }
                )
            }(t, a, r)
    }
    ...
    function () {
        ...
        window.messages = {
            ru: {
                ...
                requestError: "Ошибка при отправке запроса на сервер SafeRoute",
                ieNotSupported: "Виджет SafeRoute не поддерживает IE версии 9 и ниже"
            },
            en: {
                ...
                ieNotSupported: "SafeRoute widget does not support IE version 9 or lower"
            },
            zh: {
